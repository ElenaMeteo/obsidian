...
Notre objectif dans ce document est de justifier la présence d'erreur de représentativité et donc sa correction sur le document [[Paramètres de la distribution]]. Tout cela est basé sur la méthode utilisée sur l'article [[Accounting for representativeness in the verification of ensemble forecasts]]. 
